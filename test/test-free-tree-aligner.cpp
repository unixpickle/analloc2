...
typedef FreeTreeAligner<AvlTree, uint16_t, uint8_t> AlignerClass;

bool HandleFailure(AlignerClass::super *);

int main() {
  ScopedPass pass("FreeTreeAligner");
  
  PosixVirtualAligner posixAligner;
  AlignerClass aligner(posixAligner, HandleFailure);
  uint16_t addr;
