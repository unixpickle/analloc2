#ifndef __ANALLOC2_DYNAMIC_BST_HPP__
#define __ANALLOC2_DYNAMIC_BST_HPP__

namespace analloc {

/**
 * A binary search tree which uses dynamic memory allocation to allocate nodes.
 */
template <class T>
class DynamicBst {
public:
   ...
   */
  class ComparatorBestQuery : public BestQuery {
  public:    
    /**
